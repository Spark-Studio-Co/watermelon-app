    ...
    return (
        <AuthLayout>
            <View className='flex items-center flex-col' style={{ marginTop: hp(4) }}>
                ...
                <Button onPress={() => navigate('Dashboard' as never)} variant='blue' className='w-full flex items-center justify-center' style={{ marginTop: hp(8) }}><Text weight='regular' className='text-[22px] text-[#FFFFFF] flex'>Subscribe</Text></Button>
            </View>
        </AuthLayout>
    )
}
