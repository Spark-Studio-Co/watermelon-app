...
export const SeettingsButton = ({
  ...
  return (
    <TouchableOpacity
      activeOpacity={0.7}
      className={`${className} rounded-[15px] px-4 w-full mx-auto flex items-center justify-between flex-row`}
      {...props}
    >
      ...
      {isFriendsSettings ? (
        <View className="bg-white w-[20px] h-[20px] flex items-center justify-center rounded-full">
          <Text weight="regular" className="text-black text-[11px]">
