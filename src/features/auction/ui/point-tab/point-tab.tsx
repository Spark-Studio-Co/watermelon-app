...
export const PointTab = ({ type, name, subscribers, views, members }: IPointTabProps) => {
    return (
        <View className={`w-full flex justify-center pl-[15px] border-[0.94px] rounded-[15.1px] h-[76.46564483642578px] ${type === "Premium" ? "border-[#A009CD] bg-[#181A20]" : type === "Chat" ? "border-[#93E0FF] bg-[#181A20]" : "border-[#262A34] bg-[#262A34]"}`}>
            <View className='flex flex-row'>
                <View className="flex flex-row items-center">
                    ...
                    <View className="flex flex-col ml-[15px]">
                        ...
                        <Text weight="regular" className="text-[#5E6272] text-[11.33px]">{type === "Premium" ? "Premium" : type === "Chat" ? "Chat" : "Point"}</Text>
                    </View>
                </View>
